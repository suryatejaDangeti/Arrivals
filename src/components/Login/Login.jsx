...
import { getUserDocumentFromAuth, signInAuthUserWithEmailAndPassword } from '../../lib/firebase/firebase';
...
//                     <input className='login-input' type= "email" name="email" placeholder='Enter your email'/>
//                     <input className='login-input' type= "password" name="password" placeholder='Enter your password'/>
//                     <button className='sign-in-button'>SIGN IN</button>
//                     <div className='sign-up-container'>
//                         <p className='sign-up-link-text'>I don't have an account?</p>
//                         <button className='sign-up-link-text sign-up-link' onClick={() => setShowSignUp(true)}>SignUp</button>
//                     </div>
//             </div> :
//             <div className='login-text-container'>
//             <p className='welcome-back-text'>Get started!</p>
...
//             <div className='sign-up-container'>
//                 <p className='sign-up-link-text'>Already have an account?</p>
//                 <button className='sign-up-link-text sign-up-link' onClick={() => setShowSignUp(false)}>Login</button>
//             </div>
//     </div>
//             }

//             <div>
//             {/* width="729" height="741"  #d0c2b1b0 */}
//             <div className='svg-show'>
//                 <svg width="429" height="541" viewBox="0 0 729 741" fill="none" xmlns="http://www.w3.org/2000/svg"> 
//                     <rect x="265" width="464" height="736" fill="#fff"/>
//                     <rect x="295.27" y="532.041" width="55" height="58" transform="rotate(25.9924 295.27 532.041)" fill="#0E60FF"/>
//                     <rect x="279.902" y="425.281" width="93" height="98" rx="46.5" transform="rotate(10.9924 279.902 425.281)" fill="#d0c2b1b0"/>
//                     <path d="M30.6238 713.058C39.7655 730.029 59.1674 737.314 59.1674 737.314C59.1674 737.314 63.7478 717.084 54.6061 700.114C45.4644 683.143 26.0625 675.858 26.0625 675.858C26.0625 675.858 21.4822 696.088 30.6238 713.058Z" fill="#201F30"/>
//                     <path d="M36.9071 707.475C53.4116 717.415 59.768 737.157 59.768 737.157C59.768 737.157 39.3654 740.785 22.8609 730.845C6.3564 720.906 0 701.163 0 701.163C0 701.163 20.4027 697.536 36.9071 707.475Z" fill="#d0c2b1b0"/>
...
//                     <path d="M473.264 276.261L480.326 261.337C480.326 261.337 521.915 280.974 528.193 287.258C534.47 293.542 534.47 302.967 534.47 302.967L523.485 342.241C523.485 342.241 526.623 428.644 526.623 431.786C526.623 434.928 537.609 452.208 529.762 445.924C521.915 439.64 520.346 433.357 514.068 442.782C507.791 452.208 493.666 463.205 493.666 463.205L473.264 276.261Z" fill="#d0c2b1b0"/>
...
//                     <path d="M459.139 271.548C459.139 271.548 446.363 259.016 441.765 259.784C437.168 260.552 430.89 271.548 430.89 271.548C430.89 271.548 393.224 284.116 394.794 296.684C396.363 309.251 413.627 370.518 413.627 370.518C413.627 370.518 427.751 444.353 415.196 452.208C402.641 460.063 474.833 480.485 476.403 471.06C477.972 461.634 481.111 367.377 476.403 353.238C471.694 339.099 459.139 271.548 459.139 271.548Z" fill="#d0c2b1b0"/>
//                     <path d="M514.068 296.684H533.474C533.474 296.684 547.026 356.38 548.595 362.664C550.165 368.948 553.303 398.796 551.734 398.796C550.165 398.796 518.777 392.512 518.777 397.225L514.068 296.684Z" fill="#d0c2b1b0"/>
...
//                     <path d="M413.626 287.258L394.793 291.971L380.668 375.231C380.668 375.231 375.96 397.225 383.807 398.796C391.654 400.367 413.626 412.934 413.626 412.934C413.626 412.934 416.765 389.37 423.042 389.37L407.348 376.802L416.765 321.819L413.626 287.258Z" fill="#d0c2b1b0"/>
...
const Login = () => {
    ...
    const onSubmitForm = async (event) => {
        ...
        try {
            const response = await signInAuthUserWithEmailAndPassword(formDetails.email, formDetails.password);
            const { user } = response
    ...
    return (
        <div className='main-login-container'>
            ...
            <div className='login-container'>
                ...
                >
                    <h1 className='login-heading'>Login</h1>
                    <p className='login-text'>Existing Customers</p>
                    <CustomInput 
                        name = "email"
                        type = "email"
                        label = "Email Address"
                ...
                <div className='register-description-container'>
                    <h1 className='login-text'>New to Arrivals?</h1>
                    <p className='register-description'>
                        Get our latest product recommendations for you.
                        Personalise your Arrival experience on Mobile, tablet and desktop.
